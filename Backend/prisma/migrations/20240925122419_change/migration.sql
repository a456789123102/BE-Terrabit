...
INSERT INTO "new_Product" ("createdAt", "description", "id", "image", "name", "price", "quantity", "updatedAt") SELECT "createdAt", "description", "id", "image", "name", "price", "quantity", "updatedAt" FROM "Product";
DROP TABLE "Product";
